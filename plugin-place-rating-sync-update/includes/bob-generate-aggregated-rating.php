...
function bob_generate_aggregated_rating_value($post_id) {
    ...
    $aggregated_rating = bob_calculate_aggregated_rating_value($rating_info);
...
function bob_collect_post_rating_info($post_id) {
    ...
    $rating_info = array(
        ...
        "best_of_bali" => array(
            ...
            "count" =>  get_post_meta($post_id, "rmp_vote_count", true),
            "max_rate" => 5,
            "weight" => 10,
        ),
    );
 ...
 */
function bob_calculate_aggregated_rating_value($formatted_rating_info) {
